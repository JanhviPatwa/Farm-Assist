...
class CropHome:
    def __init__(self, top=None):#constructor function
        ...
        self.Button6.place(relx=0.33, rely=0.75, height=42, width=208)
        ...
        self.Button6.configure(text='''Recommendation.''')
        self.Button6.configure(command=self.recommendation)
        ...
        self.Label1.configure(text='''FARM-ASSIST''')
        ...
        self.Entry4 = Text(self.Frame1)
        self.Entry4.place(relx=0.46, rely=0.03, relheight=0.75, relwidth=0.48)
...
#        self.Entry4.configure(disabledforeground="#a3a3a3")
    ...
    def recommendation(self):
        ...
        self.Entry4.insert(INSERT, "The recommended dose of LEF is 20 mg/day without loading dose13, but studies have shown that the effects of 10 mg/day and 25 mg/day are similar at week 4, and the incidence of adverse events is positively correlated with the dose of LEF14.")
    ...
    def prediction(self):
        ...
        if(y_predict[0]==0):
            ...
            self.Entry3.insert(INSERT,"Leaf is unhealthy.")
            self.Button6.place(relx=0.33, rely=0.75, height=42, width=208)
            self.Button6.pack()
        else:
            self.Entry3.delete(0, "end")
            self.Entry3.insert(INSERT, "Leaf is healthy.")
